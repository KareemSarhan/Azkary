...
- [x] Task 1: Add missing Quran references to AzkarRepository
...
- [x] Task 5: Render Quran-style AyahCards in AzkarReadingItem
...
- [x] Task 6: Build, commit, and push
