...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            val prefLayoutDirection by userPreferencesRepository.layoutDirection.collectAsState(initial = LayoutDirection.SYSTEM)
            
            val layoutDirection = when (prefLayoutDirection) {
                LayoutDirection.RTL -> ComposeLayoutDirection.Rtl
                LayoutDirection.LTR -> ComposeLayoutDirection.Ltr
                LayoutDirection.SYSTEM -> LocalLayoutDirection.current
            }
